...
namespace MsgBox
{
    public static class InputBox
    {
        ...
        private static PictureBox Picture(Icon icon)
        {
            ...
            {
                case Icon.Error:
                    stream = assembly.GetManifestResourceStream(@"etaxOnethVersion2.error.png");
                    break;
                case Icon.Exclamation:
                    stream = assembly.GetManifestResourceStream(@"etaxOnethVersion2.exclamation.png");
                    break;
                case Icon.Information:
                    stream = assembly.GetManifestResourceStream(@"etaxOnethVersion2.exclamation.png");
                    break;
                case Icon.Question:
                    stream = assembly.GetManifestResourceStream(@"etaxOnethVersion2.question.png");
                    break;
                case Icon.Nothing:
                    stream = assembly.GetManifestResourceStream(@"etaxOnethVersion2.nic80x80.png");
                    break;
            }
